...
1. 將產出檔案納入版控：`public/project-images-map.json`、`public/project-images-metadata.json`、`public/project-images-metadata.zh.json`
...
1. 將產出檔案納入版控：`public/gallery-images-map.json`
