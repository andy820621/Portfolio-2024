...
export const seoData = {
  ...
  keywords: 'Web Design, Hsieh Yao Tsu, 謝耀祖, BarZ, andy820621, ヒカル, Frontend, Developer, Engineer, 前端開發, 前端工程師, HTML, CSS, Javascript, Typescript, SEO, Graphic Design,Logo,UI,UX, Blogs, 部落格, technical, 技術, Nuxt, Nuxt3, Vue3, Tailwind CSS, Uno CSS, Vite, Netlify, Vercel, Github, Nuxt Content',
